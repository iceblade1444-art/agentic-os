...
export const api = {
  ...
  personal: {
    ...
    profileFacts: () => j("/api/personal/profile-facts"),
    telegramStatus: () => j("/api/personal/telegram"),
    telegramLink: () => j("/api/personal/telegram/link", { method: "POST" }),
    telegramUnlink: () => j("/api/personal/telegram", { method: "DELETE" }),
    rememberFact: (body) => j("/api/personal/profile-facts", { method: "POST", body }),
    forgetFact: (id) => j(`/api/personal/profile-facts/${encodeURIComponent(id)}`, { method: "DELETE" }),
